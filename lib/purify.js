(function (root, factory) {
    ...
    purify.nonEmptyAlphaNumericWithDot = function (rawValue, defaultValue) {
     ...
     purify.nonEmptyAlphaNumericWithUnderscore = function (rawValue, defaultValue) {
        if (typeof rawValue === 'string' && /^\w+$/i.test(rawValue)) {
            return rawValue;
        } else if (typeof rawValue === 'number' && isFinite(rawValue) && !isNaN(rawValue)) {
            return String(rawValue);
        }
    ...
    purify.alphaNumericWithUnderscore = function (rawValue, defaultValue) {
        if (typeof rawValue === 'string' && /^\w*$/i.test(rawValue)) {
            return rawValue;
        } else if (typeof rawValue === 'number' && isFinite(rawValue) && !isNaN(rawValue)) {
            return String(rawValue);
